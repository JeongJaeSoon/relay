...
export class TaskService {
  ...
  close(taskUuid: string) {
    ...
    this.d.outbox.reap(t, "close", true);                                    // disposing of a task disposes of EVERY generation it ran, not just the one it is bound to — the forks left the rest registered
