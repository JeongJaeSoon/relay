...
export const RELAY_DOWN_MESSAGE = "relay: the server is not running — `brew services start relay` or `relay serve`";
export class RelayDown extends Error { constructor() { super(RELAY_DOWN_MESSAGE); } }
