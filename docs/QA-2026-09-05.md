...
Final automated validation: `bunx tsc --noEmit` passed; `bun test` reported **353 pass,
2 opt-in skips, 0 fail** across 54 files (1,557 assertions). Ten regression tests cover
