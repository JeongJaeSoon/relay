...
Final automated validation: `bunx tsc --noEmit` passed; `bun test` reported **350 pass,
2 opt-in skips, 0 fail** across 52 files (1,494 assertions). Seven regression tests cover
failed submissions, repeat Enter/IME, message retry identity and snapshot recovery.
