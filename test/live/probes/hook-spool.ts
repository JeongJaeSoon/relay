// test/live/probes/hook-spool.ts — prototype of `relay hook <event>`: stdin JSON → spool file (tmp → fsync → rename) → POST → delete on 2xx.
// usage: bun test/live/probes/hook-spool.ts <event> <spoolDir> <url>
